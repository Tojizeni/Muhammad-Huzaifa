...
const Contact = forwardRef((props, ref) => {
  ...
  // Moved endpoint here so it's accessible throughout the component
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            {/* Removed action and method attributes since fetch handles the submission */}
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {status && status !== "Sending..." && <p className="text-center mt-4 text-gray-400">{status}</p>}
            </form>
          </div>
